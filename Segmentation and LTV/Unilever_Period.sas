...
data month15_prob;
set month15;
if cus_tot1=0 and cus_tot2=0 and cus_tot3=0 and cus_tot4 ne 0 then R0=1;
else R0=0;

if cus_tot1=0 and cus_tot2=0 and cus_tot3 ne 0 and cus_tot4=0 then R1=1;
else R1=0;

if cus_tot1=0 and cus_tot2 ne 0 and cus_tot3=0 and cus_tot4=0 then R2=1;
else R2=0;
...
data month26_prob;
set month26;
if cus_tot2=0 and cus_tot3=0 and cus_tot4=0 and cus_tot5 ne 0 then R0=1;
else R0=0;

if cus_tot2=0 and cus_tot3=0 and cus_tot4 ne 0 and cus_tot5=0 then R1=1;
else R1=0;

if cus_tot2=0 and cus_tot3 ne 0 and cus_tot4=0 and cus_tot5=0 then R2=1;
else R2=0;
...
data month37_prob;
set month37;
if cus_tot3=0 and cus_tot4=0 and cus_tot5=0 and cus_tot6 ne 0 then R0=1;
else R0=0;

if cus_tot3=0 and cus_tot4=0 and cus_tot5 ne 0 and cus_tot6=0 then R1=1;
else R1=0;

if cus_tot3=0 and cus_tot4 ne 0 and cus_tot5=0 and cus_tot6=0 then R2=1;
else R2=0;
...
data month48_prob;
set month48;
if cus_tot4=0 and cus_tot5=0 and cus_tot6=0 and cus_tot7 ne 0 then R0=1;
else R0=0;

if cus_tot4=0 and cus_tot5=0 and cus_tot6 ne 0 and cus_tot7=0 then R1=1;
else R1=0;

if cus_tot4=0 and cus_tot5 ne 0 and cus_tot6=0 and cus_tot7=0 then R2=1;
else R2=0;
...
data month59_prob;
set month59;
if cus_tot5=0 and cus_tot6=0 and cus_tot7=0 and cus_tot8 ne 0 then R0=1;
else R0=0;

if cus_tot5=0 and cus_tot6=0 and cus_tot7 ne 0 and cus_tot8=0 then R1=1;
else R1=0;

if cus_tot5=0 and cus_tot6 ne 0 and cus_tot7=0 and cus_tot8=0 then R2=1;
else R2=0;
...
data month610_prob;
set month610;
if cus_tot6=0 and cus_tot7=0 and cus_tot8=0 and cus_tot9 ne 0 then R0=1;
else R0=0;

if cus_tot6=0 and cus_tot7=0 and cus_tot8 ne 0 and cus_tot9=0 then R1=1;
else R1=0;

if cus_tot6=0 and cus_tot7 ne 0 and cus_tot8=0 and cus_tot9=0 then R2=1;
else R2=0;
...
data month711_prob;
set month711;
if cus_tot7=0 and cus_tot8=0 and cus_tot9=0 and cus_tot10 ne 0 then R0=1;
else R0=0;

if cus_tot7=0 and cus_tot8=0 and cus_tot9 ne 0 and cus_tot10=0 then R1=1;
else R1=0;

if cus_tot7=0 and cus_tot8 ne 0 and cus_tot9=0 and cus_tot10=0 then R2=1;
else R2=0;
...
if cus_tot11=. then cus_tot11=0;
if cus_tot11 ne 0;
if cus_tot1+cus_tot2+cus_tot3+cus_tot4+cus_tot5+cus_tot6+cus_tot7+cus_tot8+cus_tot9+cus_tot10 ne 0;
run;

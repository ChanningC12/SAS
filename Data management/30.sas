...
model log1=log0 total_length_word;
model log2=log0 total_length_word;
model log3=log0 total_length_word;
run;

proc reg data=assign251;
model log1=log0 total_length_char;
model log2=log0 total_length_char;
model log3=log0 total_length_char;
run;
